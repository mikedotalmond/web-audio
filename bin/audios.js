...
Main.main = function() {
	...
	js.Browser.window.onbeforeunload = function(e) {
		haxe.Log.trace("unLoad",{ fileName : "Main.hx", lineNumber : 183, className : "Main", methodName : "main"});
...
Main.createContext = function() {
	...
	try {
		...
		haxe.Log.trace("Error creating an AudioContext",{ fileName : "Main.hx", lineNumber : 199, className : "Main", methodName : "createContext", customParams : [err]});
		c = null;
	}
	Main.context = c;
}
Main.prototype = {
	...
	,initUI: function() {
		...
		http.onError = function(err) {
			haxe.Log.trace("Error loading synth template: " + err,{ fileName : "Main.hx", lineNumber : 66, className : "Main", methodName : "initUI"});
		};
...
utils.KeyboardNotes = function() {
	...
	this.keycodeToNoteFreq.set(219,this.noteFreq.noteIndexToFrequency(this.noteFreq.noteNameToIndex("F3")));
	this.keycodeToNoteFreq.set(187,this.noteFreq.noteIndexToFrequency(this.noteFreq.noteNameToIndex("F#3")));
	this.keycodeToNoteFreq.set(221,this.noteFreq.noteIndexToFrequency(this.noteFreq.noteNameToIndex("G3")));
};
